...
// ─────────────────────────────────────────────────────────────────────────────
// i_timestamp_fifo.v (FWFT Version)
// ─────────────────────────────────────────────────────────────────────────────
// Stores I_TimeStamps (input-side timestamps) in order.
// Pushed by input_frame_counter on the FIRST beat of each incoming frame.
// Popped by timestamp_arbiter when a matching O_TimeStamp is also ready.
//
...
module i_timestamp_fifo #(
    parameter DEPTH = 8
)(
    input  wire        clk,
    input  wire        rst_n,

    // Push side — from input_frame_counter
    input  wire        push,
